              ...
              <li key={link.name} className="relative group">
                <Link
                  ...
                  className={`rounded-full px-4 py-2 transition
                    ${disabled ? "cursor-not-allowed opacity-50" : "hover:text-[#2BC287]"}
                ...
                {disabled && (
                  <span className="absolute left-1/2 -top-2.5 -translate-x-1/2 rounded-md bg-[#2BC287] px-2 py-0.5 text-[10px]  opacity-0 group-hover:opacity-100 transition">
                    Coming Soon
                  </span>
                )}
              </li>
        ...
        <div className="mt-2 rounded-xl   p-6 shadow-lg lg:hidden">
          <ul className="flex flex-col gap-4 font-medium">
              ...
              .map((link) => (
                <li key={link.name}>
                  <Link
                    ...
                    className={isActive(link.path) ? "text-[#2BC287]" : ""}
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <li className="flex justify-center gap-6 pt-6">
              <FaTwitter className="hover:text-[#2BC287]" />
              <FaTelegram className="hover:text-[#2BC287]" />
              <FaDiscord className="hover:text-[#2BC287]" />
            </li>
          </ul>
        </div>
      )}
